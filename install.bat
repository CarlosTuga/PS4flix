...
:: 2. Instalar dependências necessárias (PyYAML, PyWin32)
echo [INFO] Instalando dependências (PyYAML, PyWin32)...
python -m pip install -r requirements.txt --quiet
if %errorlevel% neq 0 (
    echo [AVISO] Falha ao instalar dependências via pip. Tentando pyyaml e pywin32 diretamente...
    python -m pip install pyyaml pywin32 --quiet
)
...
echo Por favor, insira um disco original para jogar!
echo ===================================================================
pause
