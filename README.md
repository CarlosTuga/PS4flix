# PS4flix / Batocera AutoDisc

PS4flix is a web application dashboard and launcher for PS4 payloads and homebrew games.

This repository also contains **Batocera AutoDisc**, a native Linux background daemon and Windows background process (RetroBat support) that monitors physical optical drives (`/dev/sr*`) to automatically detect and launch physical console game discs.
