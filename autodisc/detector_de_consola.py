...
# -*- coding: utf-8 -*-
#===============================================================================
# Batocera/RetroBat AutoDisc - Identificação de Consolas e Discos (Multiplataforma)
# Versão: 2.0.0
#===============================================================================
...
def read_raw_signatures(drive_path: str) -> Tuple[Optional[str], Optional[str]]:
    """
    Analisa assinaturas físicas e cruas do disco no Windows ou Linux para sistemas clássicos.
    """
    if os.name == 'nt' or sys.platform == 'win32':
        header = read_raw_sectors_win32(drive_path)
    else:
...
def identify_console_and_game(drive_path: str) -> Tuple[str, Optional[str]]:
    ...
    # 2. Tentar leitura lógica de ficheiros montados no SO
    try:
        if os.name != 'nt' and sys.platform != 'win32':
            # Garantir montagem ativa no Linux antes de ler o sistema de ficheiros
            from autodisc.detector_de_discos import mount_drive_linux
